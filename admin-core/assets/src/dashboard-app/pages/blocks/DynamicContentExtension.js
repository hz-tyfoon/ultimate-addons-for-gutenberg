...
const DynamicContentExtension = () => {
	const enableDynamicContentExtension = useSelector(
		( state ) => state.enableDynamicContentExtension
	);
	const dispatch = useDispatch();

	const dynamicContentStatus =
		'disabled' === enableDynamicContentExtension ? false : true;
		...
		>
			...
			<div className="uagb-admin-block__extension-title flex-1 min-w-0">
				...
				<a
					...
					href="https://wpspectra.com/docs/dynamic-content/"
					target="_blank"
					rel="noreferrer"
				>
