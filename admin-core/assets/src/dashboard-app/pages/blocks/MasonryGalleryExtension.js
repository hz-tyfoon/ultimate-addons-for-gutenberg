...
const MasonryGalleryExtension = () => {
	const enableMasonryExtension = useSelector(
		( state ) => state.enableMasonryExtension
	);
	const dispatch = useDispatch();

	const masonryGallerysStatus =
		'disabled' === enableMasonryExtension ? false : true;
		...
		>
			...
			<div className="uagb-admin-block__extension-title flex-1 min-w-0">
				...
				<a
					...
					href="https://wpspectra.com/docs/masonry-image-gallery/"
					target="_blank"
					rel="noreferrer"
				>
