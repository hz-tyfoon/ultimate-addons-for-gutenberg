...
const ResponsiveConditionsExtention = () => {
	const enableResponsiveConditions = useSelector(
		( state ) => state.enableResponsiveConditions
	);
	const dispatch = useDispatch();

	const displayResponsiveStatus =
		'disabled' === enableResponsiveConditions ? false : true;
		...
		>
			...
			<div className="uagb-admin-block__extension-title flex-1 min-w-0">
				...
				<a
					...
					href="https://wpspectra.com/docs/responsive-conditions/"
					target="_blank"
					rel="noreferrer"
				>
