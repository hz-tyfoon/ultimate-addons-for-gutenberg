...
const Welcome = () => {
	...
	const allowAutoPlay =
		'1' === query.get( 'spectra-activation-redirect' ) ? 1 : 0;
								...
								<div className="p-12 pt-[2.2rem]">
									...
									<div className="mr-[80px] spectra-video-container">
										...
										<iframe
											...
											src={ `https://www.youtube-nocookie.com/embed/GLNzTxArR6Y?showinfo=0&autoplay=${ allowAutoPlay }&mute=${ allowAutoPlay }&rel=0` }
											allow="autoplay"
