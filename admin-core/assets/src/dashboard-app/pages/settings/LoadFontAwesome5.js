...
const LoadFontAwesome5 = () => {
	...
	const enableFontAwesome5 = useSelector(
		( state ) => state.enableFontAwesome5
	);
	const enableFontAwesome5Status =
		'disabled' === enableFontAwesome5 ? false : true;
	...
	const updateEnableFontAwesome5Status = () => {
		...
		dispatch( {
			type: 'UPDATE_ENABLE_FONT_AWESOME_5',
			payload: assetStatus,
		} );
