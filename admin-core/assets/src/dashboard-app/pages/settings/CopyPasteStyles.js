...
const CopyPasteStyles = () => {
	...
	const enableCopyPasteStyles = useSelector(
		( state ) => state.enableCopyPasteStyles
	);
	const enableCopyPasteStylesStatus =
		'disabled' === enableCopyPasteStyles ? false : true;
	...
	const updateEnableCopyPasteStylesStatus = () => {
		...
		dispatch( {
			type: 'UPDATE_ENABLE_COPY_PASTE_STYLES',
			payload: assetStatus,
		} );
