...
const ContainerGlobalElementsGap = () => {
	const containerGlobalElementsGap = useSelector(
		( state ) => state.containerGlobalElementsGap
	);
	...
	const saveValue = ( value ) => {
		dispatch( {
			type: 'UPDATE_CONTAINER_GLOBAL_ELEMENTS_GAP',
			payload: value,
		} );
		...
		formData.append(
			'security',
			uag_react.container_global_elements_gap_nonce
		);
