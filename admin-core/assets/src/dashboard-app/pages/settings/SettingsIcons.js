const SettingsIcons = {
    ...
    'version-control': (
        <svg className="flex-shrink-0 mr-4 fill-inherit" stroke="none" width="16" height="20" viewBox="0 0 16 20" xmlns="http://www.w3.org/2000/svg">
	...
	'spectra-ai': (
		<svg className="flex-shrink-0 mr-4" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
