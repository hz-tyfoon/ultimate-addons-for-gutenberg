...
const LoadFontsLocally = () => {
	...
	const enableLoadFontsLocallyStatus =
		'disabled' === enableLoadFontsLocally ? false : true;
	...
	const updateLoadFontsLocallyStatus = () => {
		...
		formData.append( 'security', uag_react.load_gfonts_locally_nonce );
