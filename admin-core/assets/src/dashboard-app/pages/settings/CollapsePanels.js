...
const CollapsePanels = () => {
	...
	const enableCollapsePanels = useSelector(
		( state ) => state.enableCollapsePanels
	);
	const enableCollapsePanelsStatus =
		'disabled' === enableCollapsePanels ? false : true;
	...
	const updateEnableCollapsePanelsStatus = () => {
		...
		dispatch( {
			type: 'UPDATE_ENABLE_COLLAPSE_PANELS',
			payload: assetStatus,
		} );
