...
const AutoBlockRecovery = () => {
	...
	const enableAutoBlockRecovery = useSelector(
		( state ) => state.enableAutoBlockRecovery
	);
	const enableAutoBlockRecoveryStatus =
		'disabled' === enableAutoBlockRecovery ? false : true;
	...
	const updateEnableAutoBlockRecoveryStatus = () => {
		...
		dispatch( {
			type: 'UPDATE_ENABLE_AUTO_BLOCK_RECOVERY',
			payload: assetStatus,
		} );
