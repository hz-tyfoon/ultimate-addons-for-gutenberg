...
const generateBorderCSS = ( attributes, prefix, deviceType = 'desktop' ) => {
	...
	const borderTopWidthMobile = generateCSSUnit(
		attributes[ prefix + 'BorderTopWidthMobile' ],
		'px'
	);
	const borderRightWidthMobile = generateCSSUnit(
		attributes[ prefix + 'BorderRightWidthMobile' ],
		'px'
	);
	const borderBottomWidthMobile = generateCSSUnit(
		attributes[ prefix + 'BorderBottomWidthMobile' ],
		'px'
	);
	const borderLeftWidthMobile = generateCSSUnit(
		attributes[ prefix + 'BorderLeftWidthMobile' ],
		'px'
	);

	const borderTopWidthTablet = generateCSSUnit(
		attributes[ prefix + 'BorderTopWidthTablet' ],
		'px'
	);
	const borderRightWidthTablet = generateCSSUnit(
		attributes[ prefix + 'BorderRightWidthTablet' ],
		'px'
	);
	const borderBottomWidthTablet = generateCSSUnit(
		attributes[ prefix + 'BorderBottomWidthTablet' ],
		'px'
	);
	const borderLeftWidthTablet = generateCSSUnit(
		attributes[ prefix + 'BorderLeftWidthTablet' ],
		'px'
	);

	const borderRadiusUnit = generateCSSUnitType(
		attributes[ prefix + 'BorderRadiusUnit' ],
		'px'
	);
	const borderRadiusUnitTablet = generateCSSUnitType(
		attributes[ prefix + 'BorderRadiusUnitTablet' ],
		'px'
	);
	const borderRadiusUnitMobile = generateCSSUnitType(
	...
	const borderTopLeftRadiusMobile = generateCSSUnit(
		attributes[ prefix + 'BorderTopLeftRadiusMobile' ],
		borderRadiusUnitMobile
	);
	const borderTopRightRadiusMobile = generateCSSUnit(
		attributes[ prefix + 'BorderTopRightRadiusMobile' ],
		borderRadiusUnitMobile
	);
	const borderBottomRightRadiusMobile = generateCSSUnit(
		attributes[ prefix + 'BorderBottomRightRadiusMobile' ],
		borderRadiusUnitMobile
	);
	const borderBottomLeftRadiusMobile = generateCSSUnit(
		attributes[ prefix + 'BorderBottomLeftRadiusMobile' ],
		borderRadiusUnitMobile
	);

	const borderTopLeftRadiusTablet = generateCSSUnit(
		attributes[ prefix + 'BorderTopLeftRadiusTablet' ],
		borderRadiusUnitTablet
	);
	const borderTopRightRadiusTablet = generateCSSUnit(
		attributes[ prefix + 'BorderTopRightRadiusTablet' ],
		borderRadiusUnitTablet
	);
	const borderBottomRightRadiusTablet = generateCSSUnit(
		attributes[ prefix + 'BorderBottomRightRadiusTablet' ],
		borderRadiusUnitTablet
	);
	const borderBottomLeftRadiusTablet = generateCSSUnit(
	...
	if ( 'default' !== attributes[ prefix + 'BorderStyle' ] ) {
		if ( 'tablet' === deviceType ) {
			if (
				...
				borderCSS[ 'border-top-width' ] = borderTopWidthTablet
					? borderTopWidthTablet
					: borderTopWidth;
				borderCSS[ 'border-right-width' ] = borderRightWidthTablet
					? borderRightWidthTablet
					: borderRightWidth;
				borderCSS[ 'border-bottom-width' ] = borderBottomWidthTablet
					? borderBottomWidthTablet
					: borderBottomWidth;
				borderCSS[ 'border-left-width' ] = borderLeftWidthTablet
					? borderLeftWidthTablet
					: borderLeftWidth;
			}
			borderCSS[ 'border-top-left-radius' ] = borderTopLeftRadiusTablet
				? borderTopLeftRadiusTablet
				: borderTopLeftRadius;
			borderCSS[ 'border-top-right-radius' ] = borderTopRightRadiusTablet
				? borderTopRightRadiusTablet
				: borderTopRightRadius;
			borderCSS[ 'border-bottom-right-radius' ] =
				borderBottomRightRadiusTablet
					? borderBottomRightRadiusTablet
					: borderBottomRightRadius;
			borderCSS[ 'border-bottom-left-radius' ] =
			...
			if (
				...
				borderCSS[ 'border-top-width' ] = borderTopWidthMobile
					? borderTopWidthMobile
					: borderTopWidthTablet;
				borderCSS[ 'border-right-width' ] = borderRightWidthMobile
					? borderRightWidthMobile
					: borderRightWidthTablet;
				borderCSS[ 'border-bottom-width' ] = borderBottomWidthMobile
					? borderBottomWidthMobile
					: borderBottomWidthTablet;
				borderCSS[ 'border-left-width' ] = borderLeftWidthMobile
					? borderLeftWidthMobile
					: borderLeftWidthTablet;
			}
			borderCSS[ 'border-top-left-radius' ] = borderTopLeftRadiusMobile
				? borderTopLeftRadiusMobile
				: borderTopLeftRadiusTablet;
			borderCSS[ 'border-top-right-radius' ] = borderTopRightRadiusMobile
