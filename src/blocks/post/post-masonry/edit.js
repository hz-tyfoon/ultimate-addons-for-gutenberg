...
import styling from '.././styling-post-masonry';
...
const UAGBPostMasonry = ( props ) => {
			...
			<UAGAdvancedPanelBody title={ __( 'General', 'ultimate-addons-for-gutenberg' ) } initialOpen={ true }>
				...
				{ 'infinite' === paginationType && 'button' === paginationEventType && (
					<>
						...
						<MultiButtonsControl
							setAttributes={ setAttributes }
							label={ __( 'Pagination Button Alignment', 'ultimate-addons-for-gutenberg' ) }
							data={ {
			...
			return (
				...
				>
					...
					{ 'scroll' === paginationEventType && (
						<>
							<AdvancedPopColorControl
								label={ __( 'Loader Color', 'ultimate-addons-for-gutenberg' ) }
	...
	if ( ! hasPosts ) {
		return (
			<>
				{ inspectorControls }
				<Placeholder icon="admin-post" label={ __( 'Post Masonry', 'ultimate-addons-for-gutenberg' ) }>
