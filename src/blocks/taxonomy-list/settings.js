...
const Settings = ( props ) => {
	...
	const colorControl = (
		<>
			...
			{ 'none' !== listStyle && (
				<>
					<AdvancedPopColorControl
						label={ __( 'Bullet/Numbers Color', 'ultimate-addons-for-gutenberg' ) }
			...
			<UAGAdvancedPanelBody title={ __( 'Layout', 'ultimate-addons-for-gutenberg' ) } initialOpen={ false }>
				...
				{ 'list' === layout && (
					<>
						<MultiButtonsControl
							setAttributes={ setAttributes }
							label={ __( 'Display Style', 'ultimate-addons-for-gutenberg' ) }
							data={ {
							...
							options={ [
								{
									...
									tooltip: __( 'Bullet', 'ultimate-addons-for-gutenberg' ),
								},
								{
									value: 'decimal',
									icon: <Icon icon={ renderSVG( 'fa fa-list-ol' ) } />,
									tooltip: __( 'Numbers', 'ultimate-addons-for-gutenberg' ),
								},
								{
									value: 'none',
	...
	const postQueryPanel = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Query', 'ultimate-addons-for-gutenberg' ) } initialOpen={ true }>
				<UAGSelectControl
	...
	const countColorPanel = () => {
		return (
			<UAGAdvancedPanelBody title={ __( 'Count', 'ultimate-addons-for-gutenberg' ) } initialOpen={ false }>
				<AdvancedPopColorControl
					label={ __( 'Color', 'ultimate-addons-for-gutenberg' ) }
