...
import ctaPresets, {
	buttonsPresetsCTA,
	buttonsPresetsAdditionalButton,
} from './presets';
		...
		return (
			...
			>
				<ToggleControl
					...
					onChange={ () =>
						setAttributes( {
							enabledSecondCtaButton: ! enabledSecondCtaButton,
						} )
					}
				/>
				{ enabledSecondCtaButton && (
					<>
						...
						<ToggleControl
							...
							onChange={ () =>
								setAttributes( {
									secondCtaTarget: ! secondCtaTarget,
								} )
							}
						/>
						<ToggleControl
		...
		return (
			...
			>
				{ ( ( 'right' !== textAlign &&
					'none' === stack &&
					'Desktop' === deviceType ) ||
					( 'right' !== textAlignTablet &&
						'Tablet' === deviceType &&
						'none' === stack ) ||
					( 'right' !== textAlignMobile &&
						'Mobile' === deviceType &&
						'none' === stack ) ) && (
					<ResponsiveSlider
						label={ __(
