...
function styling( attributes, clientId, name, deviceType ) {
	...
	const selectors = {
		...
		'.uagb-dismissable div[role="tablist"] span svg': {
		...
		'.uagb-inline_notice__align-left div[role="tablist"] span svg': {
			'right': generateCSSUnit( titlePaddingRight, titlePaddingUnit ),
		},
		'.uagb-inline_notice__align-center div[role="tablist"] span svg': {
			'right': generateCSSUnit( titlePaddingRight, titlePaddingUnit ),
		},
	};
	...
	if ( 'modern' === layout ) {
		...
		selectors[ ' .rich-text.block-editor-rich-text__editable.uagb-notice-text' ][ 'border-bottom-right-radius' ] =
			'3px';
		selectors[ '.uagb-inline_notice__align-right div[role="tablist"] span svg' ] = {
			'left': generateCSSUnit( titlePaddingLeft, titlePaddingUnit ),
		};
		tabletSelectors[ '.uagb-inline_notice__align-right div[role="tablist"] span svg' ] = {
			'left': generateCSSUnit( posLeftTab, posLeftUnitTab ),
		};
		mobileSelectors[ '.uagb-inline_notice__align-right div[role="tablist"] span svg' ] = {
