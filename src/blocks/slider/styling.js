...
function styling( props ) {
	...
	const arrowBorderCSS = generateBorderCSS(
		props.attributes,
		'slider-arrow'
	);
	...
	arrowSizeTablet =
		'undefined' !== typeof arrowSizeTablet ? arrowSizeTablet : arrowSize;
	arrowSizeMobile =
		'undefined' !== typeof arrowSizeMobile
			? arrowSizeMobile
			: arrowSizeTablet;
	...
	arrowPaddingTablet =
		'undefined' !== typeof arrowPaddingTablet
			? arrowPaddingTablet
			: arrowPadding;
	arrowPaddingMobile =
		'undefined' !== typeof arrowPaddingMobile
			? arrowPaddingMobile
			: arrowPaddingTablet;
	...
	let selectors = {
		...
		' .swiper-pagination-bullet': {
			'background-color':
				'' === arrowBgColor || 'undefined' === typeof arrowBgColor
					? arrowColor
					: arrowBgColor,
		},
		' .swiper-wrapper': {
	...
	const sliderBackgroundCSSTablet = generateBackgroundCSS(
	...
	let tablet_selectors = {
		...
		' .swiper-button-prev': {
			...
			'width': generateCSSUnit(
				arrowPaddingTablet * 2 + arrowSizeTablet,
				'px'
			),
	...
	let mobile_selectors = {
		...
		' .swiper-button-prev': {
			...
			'width': generateCSSUnit(
				arrowPaddingMobile * 2 + arrowSizeMobile,
				'px'
			),
			'height': generateCSSUnit(
				arrowPaddingMobile * 2 + arrowSizeMobile,
