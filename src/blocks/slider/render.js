		...
		onAfterInit( swiperInst ) {
			setTimeout( () => {
				if ( swiperInst?.params?.navigation ) {
					swiperInst.params.navigation.prevEl =
						sliderNavPrevRef.current;
					swiperInst.params.navigation.nextEl =
						sliderNavNextRef.current;
				...
				if ( swiperInst?.params?.pagination ) {
					swiperInst.params.pagination.el =
			...
			{ displayArrows && (
				<>
					<div
						...
						ref={ sliderNavPrevRef }
					></div>
					<div
						className="swiper-button-next"
						ref={ sliderNavNextRef }
					></div>
				</>
			) }
		</div>
