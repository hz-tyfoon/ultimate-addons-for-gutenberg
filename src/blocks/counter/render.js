...
const Render = ( props ) => {
	...
	const iconAndImageCheck =
		...
		( ( sourceType === 'icon' && icon !== '' ) ||
			( sourceType === 'image' && iconImage.url !== '' ) );
		...
		<>
			...
			<div className="wp-block-uagb-counter__number">
				{ iconAndImageCheck &&
					...
					iconComponent }
				{ numberPrefix && (
					<span className="uagb-counter-block-prefix">
						{ numberPrefix }
					</span>
				) }
				<span
				...
				></span>
				{ numberSuffix && (
					<span className="uagb-counter-block-suffix">
						{ numberSuffix }
					</span>
				) }
				{ iconAndImageCheck &&
			...
			{ iconAndImageCheck &&
				layout === 'number' &&
				iconImgPosition === 'bottom' &&
				iconComponent }
		</>
	);

	const bars = (
		<div className="wp-block-uagb-counter-bars-container">{ number }</div>
	);
