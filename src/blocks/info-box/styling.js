...
function styling( props ) {
	...
	const iconSizeFallbackMobile = isNaN( iconSizeMobile )
		? iconSizeFallbackTablet
		: iconSizeMobile;
	const iconimgBorderRadiusFallback = getFallbackNumber(
		iconimgBorderRadius,
		'iconimgBorderRadius',
		blockName
	);
	...
	const seperatorWidthFallbackTablet = getFallbackNumber(
		seperatorWidthTablet,
		'seperatorWidthTablet',
		blockName
	);
	const seperatorWidthFallbackMobile = getFallbackNumber(
		seperatorWidthMobile,
		'seperatorWidthMobile',
		blockName
	);

	const ctaIconSpaceFallback = getFallbackNumber(
		ctaIconSpace,
		'ctaIconSpace',
		blockName
	);
	const ctaIconSpaceFallbackTablet = isNaN( ctaIconSpaceTablet )
		? ctaIconSpaceFallback
		: ctaIconSpaceTablet;
	const ctaIconSpaceFallbackMobile = isNaN( ctaIconSpaceMobile )
		? ctaIconSpaceFallbackTablet
		: ctaIconSpaceMobile;
	...
	const ctaBorderCSSTablet = generateBorderCSS(
		props.attributes,
		'btn',
		'tablet'
	);
	const ctaBorderCSSMobile = generateBorderCSS(
		props.attributes,
		'btn',
		'mobile'
	);
	...
	const boxSizingImage =
		'%' === imageWidthUnit ? 'border-box' : 'content-box';
	const boxSizingImageTablet =
		'%' === imageWidthUnitTablet ? 'border-box' : 'content-box';
	const boxSizingImageMobile =
		'%' === imageWidthUnitMobile ? 'border-box' : 'content-box';
	...
	const selectors = {
		...
		' .uagb-ifb-button-wrapper .uagb-infobox-cta-link:hover': {
			'color': ctaLinkHoverColor,
			'background-color':
				ctaBgHoverType === 'color' ? ctaBgHoverColor : 'transparent',
			'border-color': btnBorderHColor,
		},
	...
	if ( imageWidthType ) {
		...
		selectors[
			'.uagb-infobox__content-wrap .uagb-ifb-content .uagb-ifb-image-content > img'
		] = {
			'width': generateCSSUnit( imageWidthFallback, imageWidthUnit ),
		};
	...
	if ( 'after' === ctaIconPosition ) {
		selectors[
			'.uagb-infobox__content-wrap .uagb-infobox-cta-link > svg'
		] = {
			'margin-left': generateCSSUnit(
				ctaIconSpaceFallback,
				ctaIconSpaceType
	...
	mobileSelectors[ ' .uagb-infobox-cta-link.wp-block-button__link' ] =
		ctaBorderCSSMobile;
	tabletSelectors[ ' .uagb-infobox-cta-link.wp-block-button__link' ] =
		ctaBorderCSSTablet;
