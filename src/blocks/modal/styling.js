...
export default function styling( props ) {
	...
	const buttonIconSpaceFallback = getFallbackNumber(
		buttonIconSpace,
		'buttonIconSpace',
		blockName
	);
	...
	const contentBorderCSSTablet = generateBorderCSS(
		props.attributes,
		'content',
		'tablet'
	);
	const contentBorderCSSMobile = generateBorderCSS(
		props.attributes,
		'content',
		'mobile'
	);
	...
	const modalPopupContentBackgroundCSSDesktop = generateBackgroundCSS(
		...
		' .uagb-spectra-button-wrapper .uagb-modal-button-link.uagb-modal-trigger':
			{
				...
				'color': btnLinkColor,
				'background-color':
					modalTriggerBgType === 'color' ? btnBgColor : 'transparent',
				...borderCSS,
			},
	...
	const modalPopupContentBackgroundCSSTablet = generateBackgroundCSS(
	...
	const modalPopupContentBackgroundCSSMobile = generateBackgroundCSS(
