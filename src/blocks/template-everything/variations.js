		...
		innerBlocks: [
			...
			[
				'uagb/advanced-heading',
				{
					...
					subHeadSpace: 32,
					headingDesc:
						'Powerful, self-serve product and growth analytics to help you convert, engage, and retain more users. Trusted by over 4,000 startups. Powerful, self-serve product and growth analytics to help you convert, engage, and retain more users. Trusted by over 4,000 startups.',
				},
			],
			[
				'uagb/buttons',
				...
				[
					[
						'uagb/buttons-child',
						{
							...
							bottomPadding: 12,
							leftPadding: 20,
							btnBorderTopLeftRadius: 8,
							btnBorderTopRightRadius: 8,
							btnBorderBottomRightRadius: 8,
							btnBorderBottomLeftRadius: 8,
							btnBorderStyle: 'none',
						},
					],
					[
					...
					[
						...
						[
							[
								'uagb/advanced-heading',
								{
									separatorColor: '#E6E8EC',
									subHeadTransform: 'uppercase',
									separatorWidth: 100,
									headingAlign: 'center',
									seperatorStyle: 'solid',
									headFontWeight: 500,
									subHeadingColor: '#0B63E5',
									seperatorPosition: 'below-heading',
									headingTitleToggle: true,
									headingDescToggle: true,
									headingDesc: 'Standard',
									headingTag: 'h2',
									headingTitle: '$25/-',
									headingDescPosition: 'above-heading',
									headSpace: 15,
								...
								[
									[
										'uagb/buttons-child',
										{
											...
											bottomPadding: 12,
											leftPadding: 20,
											btnBorderTopLeftRadius: 7,
											btnBorderTopRightRadius: 7,
											btnBorderBottomRightRadius: 7,
											btnBorderBottomLeftRadius: 7,
											btnBorderStyle: 'none',
										},
									],
								],
