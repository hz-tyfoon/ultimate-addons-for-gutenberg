...
function styling( props ) {
	...
	const iconSpacingFallback = getFallbackNumber(
		iconSpacing,
		'iconSpacing',
		blockName
	);
	...
	tabletSelectors = {
		'.uagb-tabs__hstyle1-tablet > .uagb-tabs__panel .uagb-tab':
			borderCSSTablet,
	...
	mobileSelectors = {
		'.uagb-tabs__hstyle1-mobile > .uagb-tabs__panel .uagb-tab':
			borderCSSMobile,
		...
		'.uagb-tabs__stack11-mobile > .uagb-tabs__panel .uagb-tab':
			borderCSSMobile,
