...
export default function styling( props ) {
	...
	const boxSpacingFallback = getFallbackNumber(
		boxSpacing,
		'boxSpacing',
		blockName
	);
	const boxSpacingFallbackTablet = isNaN( boxSpacingTablet )
		? boxSpacing
		: boxSpacingTablet;
	const boxSpacingFallbackMobile = isNaN( boxSpacingMobile )
		? boxSpacingTablet
		: boxSpacingMobile;

	const internalBoxSpacingFallback = getFallbackNumber(
		internalBoxSpacing,
		'internalBoxSpacing',
		blockName
	);
	...
	const separatorRightSpacingTabletFallback = isNaN(
		separatorRightSpacingTablet
	)
		? separatorRightSpacing
		: separatorRightSpacingTablet;
	const separatorRightSpacingMobileFallback = isNaN(
		separatorRightSpacingMobile
	)
		? separatorRightSpacingTablet
		: separatorRightSpacingMobile;

	const separatorTopSpacingFallback = getFallbackNumber(
		separatorTopSpacing,
		'separatorTopSpacing',
		blockName
	);
	...
	const boxBorderCSSTablet = generateBorderCSS(
		props.attributes,
		'box',
		'tablet'
	);
	const boxBorderCSSMobile = generateBorderCSS(
		props.attributes,
		'box',
		'mobile'
	);
	...
	const selectors = {
		...
		'.wp-block-uagb-countdown .wp-block-uagb-countdown__box': {
			...
			'background-color':
				boxBgType !== 'transparent' ? boxBgColor : 'transparent',
		...
		'.wp-block-uagb-countdown .wp-block-uagb-countdown__box:not(:first-child)':
			{}, // Empty ruleset to prevent undefined error (for RTL Box Gap).
		'.wp-block-uagb-countdown div.wp-block-uagb-countdown__label': {
			'align-self':
				! isSquareBox && boxFlex === 'row'
					? labelVerticalAlignment
					: 'unset',
	...
	tabletSelectors[
		...
		'justify-content':
			boxFlexTablet !== 'column' ? boxAlignTablet : 'center',
	...
	mobileSelectors[
		...
		'justify-content':
			boxFlexMobile !== 'column' ? boxAlignMobile : 'center',
	...
	if ( showSeparator ) {
		...
		tabletSelectors[ separatorSelector ] = {
			...
			'right': generateCSSUnit(
				-separatorRightSpacingTabletFallback,
				'px'
			),
		...
		mobileSelectors[ separatorSelector ] = {
			...
			'right': generateCSSUnit(
				-separatorRightSpacingMobileFallback,
				'px'
			),
	...
	if ( isRTL ) {
		const boxGapSelectorLTR =
			'.wp-block-uagb-countdown .wp-block-uagb-countdown__box:not(:last-child)';
		const boxGapSelectorRTL =
			'.wp-block-uagb-countdown .wp-block-uagb-countdown__box:not(:first-child)';
		...
		selectors[ boxGapSelectorRTL ][ 'margin-right' ] = generateCSSUnit(
			boxSpacingFallback,
			'px'
		);
		tabletSelectors[ boxGapSelectorRTL ][ 'margin-right' ] =
			generateCSSUnit( boxSpacingFallbackTablet, 'px' );
		mobileSelectors[ boxGapSelectorRTL ][ 'margin-right' ] =
			generateCSSUnit( boxSpacingFallbackMobile, 'px' );
	}
