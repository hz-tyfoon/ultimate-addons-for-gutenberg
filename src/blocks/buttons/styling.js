...
function styling( props ) {
	...
	selectors[
		' .uagb-button__wrapper .uagb-buttons-repeater:not(.wp-block-button__link)'
	] = {
		// For Backword user.
	...
	if ( 'desktop' === stack ) {
		...
		mobileSelectors[
			'.uagb-editor-preview-mode-mobile .uagb-buttons-stack-desktop .block-editor-block-list__layout'
		] = {
			'flex-direction': 'column',
		...
		selectors[
			'.uagb-editor-preview-mode-desktop .uagb-buttons-stack-tablet .block-editor-block-list__layout'
		] = {
		...
		tabletSelectors[
			'.uagb-editor-preview-mode-tablet .uagb-buttons-stack-tablet .block-editor-block-list__layout'
		] = {
			'flex-direction': 'column',
			'row-gap': generateCSSUnit( gapTablet, 'px' ),
		};
		mobileSelectors[
			'.uagb-editor-preview-mode-mobile .uagb-buttons-stack-tablet .block-editor-block-list__layout'
		] = {
			'flex-direction': 'column',
			'row-gap': generateCSSUnit( gapMobile, 'px' ),
		};
		...
		selectors[
			'.uagb-editor-preview-mode-desktop .uagb-buttons-stack-mobile .block-editor-block-list__layout'
		] = {
			'column-gap': generateCSSUnit(
				getFallbackNumber( gap, 'gap', blockName ),
				'px'
		...
		tabletSelectors[
			'.uagb-editor-preview-mode-tablet .uagb-buttons-stack-mobile .block-editor-block-list__layout'
		] = {
			'column-gap': generateCSSUnit( gapTablet, 'px' ),
			'align-items': 'center',
		};
		mobileSelectors[
			'.uagb-editor-preview-mode-mobile .uagb-buttons-stack-mobile .block-editor-block-list__layout'
		] = {
			'flex-direction': 'column',
			'row-gap': generateCSSUnit( gapMobile, 'px' ),
		};
	...
	if ( align !== 'full' ) {
		selectors[
			'.uagb-editor-preview-mode-desktop .block-editor-inner-blocks'
		] = {
			'text-align': align,
		};
	} else {
	...
	if ( alignTablet !== 'full' ) {
		tabletSelectors[
			'.uagb-editor-preview-mode-tablet .block-editor-inner-blocks'
		] = {
	...
	if ( alignMobile !== 'full' ) {
		mobileSelectors[
			'.uagb-editor-preview-mode-mobile .block-editor-inner-blocks'
		] = {
