...
function contentTimelineStyle( props, baseSelector = false ) {
	...
	let stylingCss = '';
	let base_selector = `.editor-styles-wrapper .uagb-block-${ props.clientId.substr( 0, 8 ) }.uagb-timeline__outer-wrap`;
