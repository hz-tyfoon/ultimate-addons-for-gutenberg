	...
	( function ( t, e ) {
		...
		function a( e ) {
			if (
				...
				for (
					var l = ( h.isBorderBox = 'border-box' == u.boxSizing ),
						d = 0;
					d < o;
					d++
				) {
	...
	( function ( t, e ) {
		...
		( u.constructor = a ),
			...
			( u._transitionTo = function ( t, e ) {
				...
				if (
					( this.setPosition( t, e ), ! n || this.isTransitioning )
				) {
					var s = t - i,
						r = e - o,
						a = {};
