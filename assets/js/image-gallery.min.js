...
const UAGBImageGalleryMasonry = {
		init( r, e ) {
			let l = 2;
			const o = window.innerHeight / 1.25,
			...
			r.feedPagination && r.paginateUseLoader
				? window.addEventListener( 'scroll', function () {
						...
						var a,
							t =
								( e =
									e ||
									n ).lastElementChild.getBoundingClientRect()
									.top + window.scrollY;
						window.pageYOffset + o >= t &&
							( ( t = { page_number: l } ),
							( a = r.gridPages ),
							spectraImageGalleryLoadStatus &&
								( l > a && ( s.style.display = 'none' ),
								l <= a &&
		...
		getCustomURL( e, a ) {
			...
			return t.test( a?.customLinks[ e ] ) ? a.customLinks[ e ] : void 0;
		},
		openCustomURL( e ) {
		...
		addClickEvents( e, t ) {
			...
			a.forEach( ( e ) => {
				const a = UAGBImageGalleryMasonry.getCustomURL( e, t );
				a &&
					( ( e.style.cursor = 'pointer' ),
					e.addEventListener( 'click', () =>
						UAGBImageGalleryMasonry.openCustomURL( a )
					) );
			} );
		},
		callAjax( r, l, o, n = ! 1, s ) {
			...
			e.append( 'action', 'uag_load_image_gallery_masonry' ),
				...
				e.append( 'page_number', l.page_number ),
				...
				fetch( uagb_image_gallery.ajax_url, {
					...
					.then( function ( e ) {
						...
						a = a || r;
						const t = new Isotope( a, {
							itemSelector:
								'.spectra-image-gallery__media-wrapper--isotope',
							stagger: 10,
						} );
						t.insert(
							UAGBImageGalleryMasonry.createElementFromHTML(
								e.data
							)
						),
	...
	UAGBImageGalleryPagedGrid = {
		init( l, e ) {
			...
			for ( let e = 0; e < s.length; e++ )
				s[ e ].addEventListener( 'click', ( e ) => {
					...
					let t = o;
					switch ( a.getAttribute( 'data-direction' ) ) {
						case 'Prev':
							--t;
							break;
						case 'Next':
					...
					t === e || 1 === t
						...
						t <= e &&
							1 <= t &&
							( UAGBImageGalleryPagedGrid.callAjax( n, r, l, s ),
							( o = t ) );
				} );
			for ( let e = 0; e < a.length; e++ )
				a[ e ].addEventListener( 'click', ( e ) => {
					const a = e.currentTarget;
					var e = a.getAttribute( 'data-go-to' ),
						t =
							( n?.querySelector(
								'.spectra-image-gallery__media-wrapper'
							) || n,
							{ page_number: e, total: l.gridPages } );
					UAGBImageGalleryPagedGrid.callAjax( n, t, l, s ), ( o = e );
				} );
		},
		createElementFromHTML( e ) {
			const a = document.createElement( 'div' );
		...
		addClickEvents( e, t ) {
			...
			a.forEach( ( e ) => {
				const a = UAGBImageGalleryPagedGrid.getCustomURL( e, t );
				a &&
					( ( e.style.cursor = 'pointer' ),
					e.addEventListener( 'click', () =>
						UAGBImageGalleryPagedGrid.openCustomURL( a )
					) );
			} );
		},
		callAjax( o, n, s, i ) {
			...
			e.append( 'action', 'uag_load_image_gallery_grid_pagination' ),
				...
				e.append( 'attr', JSON.stringify( s ) ),
				fetch( uagb_image_gallery.ajax_url, {
					method: 'POST',
					credentials: 'same-origin',
					body: e,
						...
						if ( ! 1 !== a.success ) {
							...
							const t = ( e = e || o ).querySelectorAll(
								...
								l =
									...
									r.insert(
										UAGBImageGalleryPagedGrid.createElementFromHTML(
											a.data
										)
									),
									imagesLoaded( e ).on(
									...
									s.customLinks &&
										UAGBImageGalleryPagedGrid.addClickEvents(
											e,
											s
										),
