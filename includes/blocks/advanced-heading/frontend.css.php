...
return UAGB_Helper::generate_all_css( $combined_selectors, $base_selector . $id, array( 'globalBlockStyleName' => $attr['globalBlockStyleName'], 'globalBlockStyleId' => $attr['globalBlockStyleId'] ) );
