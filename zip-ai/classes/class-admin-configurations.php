...
class Admin_Configurations {
	...
	public function setup_menu() {
		...
		add_submenu_page(
			...
			'Zip - AI Assistant', // The page title.
			'Zip - AI Assistant', // The menu title.
	...
	public function verify_zip_ai_authorization() {
		...
		$middleware_url = wp_parse_url( ZIP_AI_MIDDLEWARE );
		...
		// Redirect to the settings page.
		wp_safe_redirect( admin_url( 'tools.php?page=zip-ai' ) );
		exit;
	}
	...
	public function enqueue_styles_and_scripts() {
		...
		$localize = apply_filters(
			...
			array(
				...
				'zip_ai_credit_details'   => $credit_details,
			)
		);
	...
	public function add_footer_link() {
		return '<span id="footer-thankyou">' . sprintf(
			...
			'<a href="https://zipwp.com/" class="focus:text-spec-hover active:text-spec-hover hover:text-spec-hover">',
			'</a>'
		) . '</span>';
	}
}
